...
**Tower** names the lab integration profile under `integration/tower/`; it is not a host identity, operator hostname, or protected infrastructure label.
